	...
	<div id="page" class="site">
		<header id="masthead" class="sheader site-header clearfix">
			...
			<nav id="primary-site-navigation" class="primary-menu main-navigation clearfix">
				<a href="#" id="pull" class="smenu-hide toggle-mobile-menu menu-toggle" aria-controls="secondary-menu" aria-expanded="false"><?php esc_html_e( 'Menu', 'minimalistblog-stories' ); ?>
			</a>
		...
		<div class="super-menu clearfix">
			<div class="super-menu-inner">
				<a href="#" id="pull" class="toggle-mobile-menu menu-toggle" aria-controls="secondary-menu" aria-expanded="false"><?php esc_html_e( 'Menu', 'minimalistblog-stories' ); ?></a>
				<?php if ( get_theme_mod( 'show_wc_cart' ) == '1' ) : ?>
					<?php if ( class_exists( 'WooCommerce' ) ) : ?>
