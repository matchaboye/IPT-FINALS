	...
	<div class="entry-content">
		...
		the_excerpt( sprintf(
			wp_kses(
				...
				__( 'Continue reading<span class="screen-reader-text"> "%s"</span>', 'minimalistblog-stories' ),
				array(
					'span' => array(
						'class' => array(),
						),
		...
		wp_link_pages( array(
			...
			<div class="text-center">
				<a href="<?php the_permalink() ?>" class="blogpost-button"><?php echo __('Read more', 'minimalistblog-stories') ?></a>
			</div>
		</div><!-- .entry-content -->
